...
export default function ResultadosLista(props) {
    ...
    useEffect(() => {
        setLoading(true);
        fetch(`https://ltgprocure.com/APIAppDoctores/APIDoctoresBusquedaPaciente.php?ApellidoPaterno=${busqueda.paterno}&ApellidoMaterno=${busqueda.materno}&Nombre=${busqueda.nombre}`)
