...
import DatosPuntosForm from "../../components/MovimientosPuntos/DatosPuntosForm";


      

export default function DetallePuntos(props) {
    ...
    <KeyboardAwareScrollView>
      <View style={styles.viewForm}>
        <DatosPuntosForm
          ...
          puntosProps={route.params.puntosProps}
        />
      </View>
