...
export default function LoginForm(props) {
        ...
        // console.log(formData);
             if(isEmpty(formData.email) || isEmpty(formData.password)  ){
                ...
                toastRef.current.show("El email no tiene formato correcto");
                 ...
                 const response = await fetch(`http://procureltg.com/Pruebas/APIAppDoctores/APIDoctoresLogin.php?Login=${formData.email}&Password=${formData.password}&Nombre=${formData.nombre}&Fecha=&Sexo=&CedProf=${formData.cedula}&Curp=&Passwd=${formData.password}`);
    ...
    const callAPILogin = async() =>{
        ...
        await fetch('https://procureltg.com/Pruebas/APIAppDoctores/APIDoctoresLogin.php?Login='+formData.email+'&Password='+formData.password,{
            method: 'GET',
            headers: {
        ...
        .then(json => {
            console.log('callAPILogin Codigo: '+json.Codigo);
            setData(json.Codigo);
        })
