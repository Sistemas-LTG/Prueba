    ...
    const onSubmit = async () =>{
            ...
            isEmpty(formData.telefono)){
               ...
               toastRef.current.show("El email no tiene formato correcto");
                ...
                setLoading(true);
                await fetch(`http://procureltg.com/Pruebas/APIAppDoctores/APIDoctoresRegistro.php?ApPaterno=${formData.apPaterno}&ApMaterno=${formData.apMaterno}&Nombre=${formData.nombre}&Fecha=&Sexo=&CedProf=${formData.cedula}&Curp=&Passwd=${formData.password}&Mail=${formData.email}&Tel=${formData.telefono}&Dir=${formData.direccion}`)
