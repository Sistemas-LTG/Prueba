...
export default function ResultadosLista(props) {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    console.log(`http://procureltg.com/Pruebas/APIAppDoctores/APIDoctoresDetalleSolicitud.php?Idsesion=${usuarioLogeado}&Nombre=${busqueda.nombre}&ApPaterno=${busqueda.paterno}&ApMaterno=${busqueda.materno}&IdSolicitudMedica=${busqueda.IdSolicitudMedica}`);
    fetch(
      `http://procureltg.com/Pruebas/APIAppDoctores/APIDoctoresDetalleSolicitud.php?Idsesion=${usuarioLogeado}&Nombre=${busqueda.nombre}&ApPaterno=${busqueda.paterno}&ApMaterno=${busqueda.materno}&IdSolicitudMedica=${busqueda.IdSolicitudMedica}`
    )
